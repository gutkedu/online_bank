...
func (t *TransactionRepositoryDb) SaveTransaction(
	transaction domain.Transaction,
	creditCard domain.CreditCard) error {
...
func (t *TransactionRepositoryDb) updateBalance(creditCart domain.CreditCard) error {
	_, err := t.db.Exec(`update credit_cards set balance = $1 where id $2`,
		creditCart.Balance, creditCart.ID)
	if err != nil {
		return err
	}
	return nil
